...
function removeParam(sourceURL) {
  ...
  function findCurrentPage() {
    ...
    else if (currentPageUrl.urlWithoutParams.includes('/collections/') || currentPageUrl.params.includes('/collections/')) {
      currentPage = "Collection"
    } else if (currentPageUrl.urlWithoutParams.includes('/products/') || currentPageUrl.params.includes('/products/')) {
      currentPage = "Product"
    } else if (currentPageUrl.urlWithoutParams.includes('/cart/') || currentPageUrl.params.includes('/cart/')) {
      currentPage = "Cart"
    } else if (currentPageUrl.urlWithoutParams.includes('/search/') || currentPageUrl.params.includes('/search/')) {
      currentPage = "Search"
    } else {
      currentPage = "All"
    }
